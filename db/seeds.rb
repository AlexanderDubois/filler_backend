...
u1 = User.create(username: "Sander", email: "sander@gmail.com")
u2 = User.create(username: "Stu", email: "stu@gmail.com")
u3 = User.create(username: "Kian", email: "kian@gmail.com")
u4 = User.create(username: "Sofia", email: "sofia@gmail.com")
...
r1 = Review.create(title: "Great", text: "Very good", star: 5, practitioner_id: p1.id, user_id: u1.id)
r1 = Review.create(title: "Bad", text: "Not good", star: 1, practitioner_id: p1.id, user_id: u2.id)
r1 = Review.create(title: "Coool", text: "Cool / good", star: 4, practitioner_id: p3.id, user_id: u3.id)
r1 = Review.create(title: "OK", text: " OK", star: 3, practitioner_id: p4.id, user_id: u4.id)
